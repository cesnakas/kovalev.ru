...
// 				else
// 				{
// 					if(!$("#userData").prop("checked")) {
// 						$("label[for=userData]").css("color", "red");
// 					} else {
// 						this.doSaveAction();
// 					}
// 				}
...
// 			}
// 			console.log(this.result.TOTAL.ORDER_PRICE);
// 			if(this.result.TOTAL.ORDER_PRICE < 500){
// 				let diffCost = 500 - this.result.TOTAL.ORDER_PRICE;
// 				this.totalInfoBlockNode.appendChild(BX.create('DIV', {
// 						props: {className: 'bx-soa-cart-total-line'},
// 						children: 'До бесплатной доставки нужно добавить товаров еще на ' + diffCost + ' рублей'
// 					})
// 				);
// 			}
