...
<div class="product-section">
    <div class="container">
        <h2 class="title-section"><?=$arParams["TITLE"]?></h2>
        <div class="products-wrap">
                    ...
                    foreach ($arResult['ITEMS'] as $arItem) {
                        ...
                        <div class="products-list__item" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
                            <div class="products-card">
                                ...
                                <div class="products-card__text"><?= $arItem["PREVIEW_TEXT"] ?>
                                </div>
            ...
            <div class="products-btn-wrap">
                <a href="/contacts/" class="black-btn-light">Заказать консультацию</a>
                <a href="/catalog/" class="black-btn">Посмотреть все сборы</a>
            </div>
        </div>
    </div>
</div>
