;(function () {
    ...
    BX.Sale.BasketComponent = {
        ...
        fillTotalBlocks: function () {
            ...
            var totalNodes = document.getElementById('total_block');
            ...
            if (totalNodes) {
                ...
                if (totalTemplate) {
                    ...
                    totalNodes.innerHTML = totalRender;
                    this.bindTotalEvents(totalNodes);

					document.getElementById('totalpricer').innerHTML=this.result.allSum_FORMATED;
