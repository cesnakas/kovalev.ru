...
if (empty($arResult['ERROR_MESSAGE'])) {
    ...
    <div class="container">
        <div class="basket-page">
            <h1 class="title-page title-page--no_bg">Корзина</h1>


            <div class="basket-table bx-step-opacity" id="basket-root">
                <div class="basket-t-head">
                    <div class="basket-t-head__item basket-t-head__item--img">Продукт</div>
                    <div class="basket-t-head__item basket-t-head__item--name"></div>
                    <div class="basket-t-head__item basket-t-head__item--weight">Вес</div>
                    <div class="basket-t-head__item basket-t-head__item--count">Количество</div>
                    <div class="basket-t-head__item basket-t-head__item--price">Цена</div>
                    <div class="basket-t-head__item basket-t-head__item--del"></div>
                </div>
                <!--   Корзина табле-->

                <div class="basket-t-body " id="basket-item-table">
            ...
            <div class="" id="basket-warning" style="display: none;">
            ...
            if (
                ...
                <div class="simple-total" id="total_block" data-entity="basket-total-block"></div>
