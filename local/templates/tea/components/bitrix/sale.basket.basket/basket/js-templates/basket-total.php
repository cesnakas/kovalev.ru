...
<script id="basket-total-template" type="text/html">
    ...
    <div class="" data-entity="basket-checkout-aligner">
        ...
        {{/DISCOUNT_PRICE_FORMATED}}
        <span class="simple-total__title">Всего:</span>
        <span class="price" id="totalpricer" data-entity="basket-total-price">
							{{{PRICE_FORMATED}}}
						</span>
        ...
        <a href="/order/" style="cursor: pointer"
           class="pay-btn pay-btn--lg {{#DISABLE_CHECKOUT}} disabled{{/DISABLE_CHECKOUT}}"
