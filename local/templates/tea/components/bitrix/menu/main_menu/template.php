...
foreach($arResult as $arItem):?>
	...
	<?if ($arItem["IS_PARENT"]):?>
		...
		<?if ($arItem["DEPTH_LEVEL"] == 1):?>
			<li class="nav__li nav__li--dropdown"><a href="<?=$arItem["LINK"]?>" class="nav__link <?if ($arItem["SELECTED"]):?>selected<?endif?>"><?=$arItem["TEXT"]?></a>
				<ul class="nav__hover">
		<?else:?>
	...
	<?else:?>
		...
		<?if ($arItem["PERMISSION"] > "D"):?>
			...
			<?if ($arItem["DEPTH_LEVEL"] == 1):?>
				<li class="nav__li"><a href="<?=$arItem["LINK"]?>" class="nav__link <?if ($arItem["SELECTED"]):?>selected<?endif?>"><?=$arItem["TEXT"]?></a></li>
			<?else:?>
...
<?endif?>
                    ...
                    <li class="nav__li nav__li--mobile">
